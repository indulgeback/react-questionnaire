...
## [1.9.2](https://github.com/indulgeback/react-questionnaire/compare/v1.9.1...v1.9.2) (2025-01-03)


### Bug Fixes

* FE - 修复登录等页面背景尺寸错乱的问题 ([fa6df32](https://github.com/indulgeback/react-questionnaire/commit/fa6df323d2ecd7afdb7ceb181b0d8763197ae10c))
...
* FE - 优化首页动效；完成生成问卷的问题提取； ([c7da0ce](https://github.com/indulgeback/react-questionnaire/commit/c7da0ceb289b66604b3787dbe22a8e209c28857a))
